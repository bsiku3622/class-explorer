        ...
        <main className="mx-auto w-full max-w-3xl px-5 py-12 md:px-8 md:py-16">
            ...
            <Table
                ...
                rows={[
                    ...
                    [
                        "자료실 제출",
                        "업로드 파일, 제목, 설명, 연결한 학기·과목, 업로드 계정, 검수 상태",
                        "이용자가 화면에서 직접 제출",
                    ],
                ]}
            />
            ...
            <Ul
                items={[
                    ...
                    <>
                        <b>과목 자료 공유</b> — 이용자가 올린 강의계획서와 수업 자료를
                        관리자가 검수한 뒤, 로그인한 학교 구성원이 열람하고
                        다운로드하게 합니다.
                    </>,
                ]}
            />
            ...
            <Table
                ...
                rows={[
                    ...
                    [
                        "자료실 제출 파일과 검수 기록",
                        "제출자가 철회하거나 관리자가 삭제할 때까지. 계정을 삭제하면 해당 계정이 올린 자료도 같이 삭제됩니다",
                    ],
                    [
                        "접속 기록(IP·기기·세션)",
            ...
            <P>
                승인된 자료실 파일과 설명은 로그인한 학교 구성원에게 공개됩니다.
                일반 이용자 화면에는 업로드 계정을 표시하지 않으며, 검수와 삭제를
                담당하는 관리자만 제출자를 확인합니다.
            </P>
