...
| `HomePage` | `/` | 홈 — **껍데기**(fetch·시계·DEV 스위치)이고 화면은 `home/TodayCardV3`(배포본)가 그립니다. V1·V2 는 개발에서만 되돌아볼 수 있습니다 |
